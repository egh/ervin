...
NEWS_FEED_ID = getattr(settings, "ERVIN_NEWS_FEED_ID", "BROKEN FEED ID")
NEWS_FEED_TITLE = getattr(settings, "ERVIN_NEWS_FEED_TITLE", "News")
...
NOID_DIR = getattr(settings, 'ERVIN_NOID_DIR', '.')
